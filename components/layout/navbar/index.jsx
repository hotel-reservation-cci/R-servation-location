  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50">
      <div className="bg-primary-color px-4 w-screen h-14 flex relative items-center justify-between lg:px-10 xl:px-20">
        <Link href="/">
          <div className="font-bold text-white lg:w-2/5 md:w-2/12 cursor-default">
            Hotely
          </div>
        </Link>

        <div className={`${show ? "flex" : "hidden"} justify-between  items-start md:items-center absolute md:space-x-4 md:relative md:flex md:flex-row flex-col white bg-white md:bg-transparent shadow md:shadow-none py-2 w-full left-0 top-14 px-4 md:top-0 md:right-0`}>
